<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
        <div style="text-align: left;" id="branding_element">
          <h4 style="color: #a2a3b7;text-align: -webkit-center;margin-bottom: 25px;font-weight: 300;margin-top: 0px;margin-left:30px;">
              <a href="#"><img class="nav-icon" src="<?php echo base_url('assets/global/logo.png'); ?>" style="max-height:70px;"></a>
          </h4>
        </div>
