...
// if ($db_file_write_perm == true) {
//     echo "working";exit;
// }
// echo $db_file_write_perm . "," . $routes_file_write_perm . "," . $curl_enabled;exit;
                ...
                <div class="panel panel-default" data-collapsed="0" style="border-color: #dedede;">
                    ...
                    <div class="panel-body" style="font-size: 14px;">
                        <p style="font-size: 14px;">
                            We ran diagnosis on your server. Review the items that have a red mark on it. If everything
                            is green, you
                        ...
                        <p style="font-size: 14px;">
                            <strong>To continue the installation process, all the above requirements are needed to be
                                checked</strong>
                        </p>
                        <br>
                        <?php if ($valid == true) {?>
