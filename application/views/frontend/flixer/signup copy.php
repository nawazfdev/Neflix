...
<div style="width:100%; height:90px; background-color:#fafafa; border-bottom:solid 1px #dcdde0;">
	...
	<div style="float: right;margin: 18px 40px; height: 50px;">
		<a href="<?php echo base_url();?>index.php?home/signin" class="" style="color: rgb(1, 93, 239);font-weight: 700;font-size: 20px;"><?= get_phrase('sign_in'); ?></a>
	</div>
	<?php if(addon_status('blog')): ?>
		<div style="float: right;margin: 18px 40px; height: 50px;">
			<a href="<?php echo base_url();?>index.php?addons/blog" class="" style="color: rgb(1, 93, 239);font-weight: 700;font-size: 20px;"><?= get_phrase('blog'); ?></a>
		</div>
	<?php endif; ?>
</div>
<!-- ERROR MESSAGE -->
