...
<?php
	...
	?>
 <div style="background-image: url(<?php echo $this->crud_model->get_poster_url('movie', $featured_movie->movie_id); ?>); background-size: cover; width: 100%; height: 100vh; display: flex; align-items: center; justify-content: center; margin-top:-50px;">
    <div class="mobile_responsive" style="font-weight: bold; color: #fff; text-align: center;">
