...
<head>
    ...
    <?php
    if ($page_name == 'signup' || $page_name == 'signin') {
    ?>
     <link rel="stylesheet" href="<?php echo base_url() . 'assets/frontend/' . $selected_theme; ?>/bootstrap.css" media="screen">
        ...
        <link rel="stylesheet" href="<?php echo base_url() . 'assets/frontend/' . $selected_theme; ?>/login.css">
        <script src="<?php echo base_url() . 'assets/frontend/' . $selected_theme; ?>/login.js"></script>
...
$bg_color = "#000";
if (
    $page_name == 'signup' || $page_name == 'signin' || $page_name == 'faq' ||
