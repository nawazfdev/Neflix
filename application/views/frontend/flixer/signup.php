...
<div class="login-container">
    ...
    <div class="mymodal">
        <div class="collapse-btn">
            <button class="login-collapse" id="login-clp" onclick="signupChange('<?php echo base_url(); ?>')">Sign Up</button>
            <button class="signup-collapse" id="signup-clp" onclick="loginChange('<?php echo base_url(); ?>')">Login</button>
        </div>
        ...
        <form class="form" action="<?php echo base_url(); ?>index.php?home/signup" method="POST">
            <input type="hidden" name="_token" value="iJxLToF31pwYxip5BzoM4OvAC5yfa7oavVTz4X8Q" autocomplete="off">
            <div class="login--options">
                <a href="#" class="btns"><button name="Google" type="button">Sign Up with Google</button></a>
                <a href="#" class="btns"><button name="facebook" type="button">Sign Up with Facebook</button></a>
                <a href="#" class="btns"><button name="twitter" type="button">Sign Up with Twitter</button></a>
            </div>
            <div class="separator">
                <hr class="line">
                <p>OR</p>
            ...
            <div class="login-info--form">
                <div class="input_container">
                    ...
                    <input id="password_field" class="input_field" type="email" name="email" title="Input email" placeholder="Email" required>
                </div>
                <div class="input_container">
                    <label for="password_field" class="input_label">Password</label>
                    <input id="password_field" class="input_field" type="password" name="password" title="Input Password" placeholder="Password" required>
                </div>
