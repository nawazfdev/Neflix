...
AmCharts.Class = function(a) {
    var b = function() { arguments[0] !== AmCharts.inheriting && (this.events = {}, this.construct.apply(this, arguments)) };
    a.inherits ? (b.prototype = new a.inherits(AmCharts.inheriting), b.base = a.inherits.prototype, delete a.inherits) : (b.prototype.createEvents = function() { for (var a = 0, b = arguments.length; a < b; a++) this.events[arguments[a]] = [] }, b.prototype.listenTo = function(a, b, c) { this.removeListener(a, b, c);
        a.events[b].push({ handler: c, scope: this }) }, b.prototype.addListener = function(a, b, c) {
        this.removeListener(this,
            a, b);
        this.events[a].push({ handler: b, scope: c })
    }, b.prototype.removeListener = function(a, b, c) { if (a && a.events)
            for (a = a.events[b], b = a.length - 1; 0 <= b; b--) a[b].handler === c && a.splice(b, 1) }, b.prototype.fire = function(a, b) { for (var c = this.events[a], g = 0, h = c.length; g < h; g++) { var k = c[g];
...
AmCharts.isModern = !0;
AmCharts.getIEVersion = function() { var a = 0; if ("Microsoft Internet Explorer" == navigator.appName) { var b = navigator.userAgent,
            c = /MSIE ([0-9]{1,}[.0-9]{0,})/;
        null != c.exec(b) && (a = parseFloat(RegExp.$1)) } else "Netscape" == navigator.appName && (b = navigator.userAgent, c = /Trident\/.*rv:([0-9]{1,}[.0-9]{0,})/, null != c.exec(b) && (a = parseFloat(RegExp.$1))); return a };
...
AmCharts.handleLoad = function() { AmCharts.isReady = !0; for (var a = AmCharts.onReadyArray, b = 0; b < a.length; b++) { var c = a[b];
...
AmCharts.makeChart = function(a, b, c) {
    ...
    switch (d) {
        case "serial":
            f = new AmCharts.AmSerialChart(e); break;
        case "xy":
            f = new AmCharts.AmXYChart(e); break;
        case "pie":
            f = new AmCharts.AmPieChart(e); break;
        case "radar":
            f = new AmCharts.AmRadarChart(e); break;
        case "gauge":
            f = new AmCharts.AmAngularGauge(e); break;
        case "funnel":
            f = new AmCharts.AmFunnelChart(e); break;
        case "map":
            f = new AmCharts.AmMap(e); break;
        case "stock":
...
AmCharts.realWrite = function(a, b) { a.write(b) };
...
AmCharts.wrappedText = function(a, b, c, d, e, f, g, h, k) {
    ...
    if (l) {
        ...
        if (p.width > h) {
            ...
            for (var s = Math.round(b.length / 2), q = 1E3, r, n = 0; n < l.length; n++) { var u = Math.abs(l[n] - s);
                u < q && (r = l[n], q = u) }
            if (isNaN(r)) {
...
AmCharts.removePx = function(a) { if (void 0 != a) return Number(a.substring(0, a.length - 2)) };
...
AmCharts.getObjById = function(a, b) { var c, d; for (d = 0; d < a.length; d++) { var e = a[d];
        e.id == b && (c = e) } return c };
...
AmCharts.extend = function(a, b, c) { for (var d in b) c ? a.hasOwnProperty(d) || (a[d] = b[d]) : a[d] = b[d]; return a };
...
AmCharts.processObject = function(a, b, c) {!1 === a instanceof b && (a = AmCharts.extend(new b(c), a)); return a };
...
AmCharts.bounce = function(a, b, c, d, e) { return (b /= e) < 1 / 2.75 ? 7.5625 * d * b * b + c : b < 2 / 2.75 ? d * (7.5625 * (b -= 1.5 / 2.75) * b + 0.75) + c : b < 2.5 / 2.75 ? d * (7.5625 * (b -= 2.25 / 2.75) * b + 0.9375) + c : d * (7.5625 * (b -= 2.625 / 2.75) * b + 0.984375) + c };
AmCharts.easeInSine = function(a, b, c, d, e) { return -d * Math.cos(b / e * (Math.PI / 2)) + d + c };
AmCharts.easeOutSine = function(a, b, c, d, e) { return d * Math.sin(b / e * (Math.PI / 2)) + c };
AmCharts.easeOutElastic = function(a, b, c, d, e) { a = 1.70158; var f = 0,
...
AmCharts.AxisBase = AmCharts.Class({
    ...
    addTitle: function() { var a = this.title; if (a) { var b = this.chart,
                c = this.titleColor;
            void 0 === c && (c = b.color); var d = this.titleFontSize;
    ...
    pushAxisItem: function(a, b) { var c = this,
            d = a.graphics();
        0 < d.length() && (b ? c.labelsSet.push(d) : c.set.push(d)); if (d = a.getLabel()) this.labelsSet.push(d), d.click(function(b) { c.handleMouse(b, a, "clickItem") }).mouseover(function(b) { c.handleMouse(b, a, "rollOverItem") }).mouseout(function(b) { c.handleMouse(b, a, "rollOutItem") }) },
    handleMouse: function(a,
        b, c) { this.fire(c, { type: c, value: b.value, serialDataItem: b.serialDataItem, axis: this, target: b.label, chart: this.chart, event: a }) },
    addGuide: function(a) { var b = this.guides; - 1 == b.indexOf(a) && b.push(a) },
...
AmCharts.ValueAxis = AmCharts.Class({
                ...
                for (d = n; d < s; d += p)
                    if (n =
                        ...
                        if (isNaN(u) || Number(AmCharts.toFixed(n, u)) == n) {
                            ...
                            this.pushAxisItem(t);
                            if (n == this.baseValue && "radar" != a.type) { var B, K, A = this.viW,
                                    z = this.viH;
                                t = this.viX;
                                E = this.viY; "H" == this.orientation ? 0 <= c && c <= A + 1 && (B = [c, c, c + e], K = [z, 0, f]) : 0 <= c && c <= z + 1 && (B = [0, A, A + e], K = [c, c, c + f]);
                            ...
                            if (!isNaN(G) &&
                                0 < y && d < s - 1) { t = this.gridAlpha;
                                this.gridAlpha = this.minorGridAlpha; for (c = 1; c < r / G; c++) E = this.getCoordinate(n + G * c), E = new this.axisItemRenderer(this, E, "", !1, 0, 0, !1, !1, 0, !0), this.pushAxisItem(E);
                                this.gridAlpha = t }
                        }
                d = this.baseValue;
    ...
    recalculate: function() {
        ...
        for (c = 0; c < b.length; c++) {
            ...
            if (d.valueAxis == this) {
                ...
                for (e = k; e <= h; e++) { g = this.data[e].axes[this.id].graphs[d.id];
                    g.percents = {}; var k = g.values,
                        n; for (n in k) g.percents[n] = "percents" != n ? k[n] / f * 100 - 100 : k[n] }
            }
        }
    },
    getMinMax: function() {
    ...
    coordinateToValue: function(a) { if (isNaN(a)) return NaN; var b = this.axisWidth,
            ...
            e = this.rotate,
            f = this.min,
            g = this.minReal; return !0 === this.logarithmic ? Math.pow(10, (e ? !0 === d ? (b - a) / c : a / c : !0 === d ? a / c : (b - a) / c) + Math.log(g) * Math.LOG10E) : !0 === d ? e ? f - (a - b) / c : a / c + f : e ? a / c + f : f - (a - b) / c },
        ...
        if ("H" == Na) {
            if (0 <= b && b <= X + 1 && (0 < t && 0 < v && b + k <= X + 1 && (ra = AmCharts.line(s, [b + k, b + k], [0, t], u, v, y), q.push(ra)), 0 < w && (P = AmCharts.line(s, [b, b + ca, b + ca], [U, U + W, W], E, w, y, z), q.push(P))), F = 0, H = b, g && 90 == B && (H -= p), !1 === d ? (P = "start", F = "bottom" == ga ? M ? F + t : F - t : M ? F - t : F + t, H += 3, e && (H += e / 2, P = "middle"), 0 < B && (P = "middle")) : P =
                "middle", 1 == K && 0 < I && !g && !l && ma < X && (d = AmCharts.fitToBounds(b, 0, X), ma = AmCharts.fitToBounds(ma, 0, X), pa = d - ma, 0 < pa && (fill = AmCharts.rect(s, pa, a.height, A, I), fill.translate(d - pa + ca, W), q.push(fill))), "bottom" == ga ? (F += U + p / 2 + $, M ? 0 < B ? (F = U - da / 2 * Math.sin(Y) - t - 3, H += da / 2 * Math.cos(Y) - 4 + 2) : 0 > B ? (F = U + da * Math.sin(Y) - t - 3 + 2, H += -da * Math.cos(Y) - ha * Math.sin(Y) - 4) : F -= t + p + 3 + 3 : 0 < B ? (F = U + da / 2 * Math.sin(Y) + t + 3, H -= da / 2 * Math.cos(Y)) : 0 > B ? (F = U + t + 3 - da / 2 * Math.sin(Y) + 2, H += da / 2 * Math.cos(Y)) : F += t + r + 3 + 3) : (F += W + p / 2 - $, H += ca, M ? 0 < B ? (F = da / 2 * Math.sin(Y) +
                    t + 3, H -= da / 2 * Math.cos(Y)) : F += t + 3 : 0 < B ? (F = -(da / 2) * Math.sin(Y) - t - 6, H += da / 2 * Math.cos(Y)) : F -= t + p + 3 + r + 3), "bottom" == ga ? pa = (M ? U - t - 1 : U + r - 1) + $ : (V = ca, pa = (M ? W : W - t - r + 1) - $), f && (H += f), W = H, 0 < B && (W += da / 2 * Math.cos(Y)), x && (ga = 0, M && (ga = da / 2 * Math.cos(Y)), W + ga > X + 2 || 0 > W)) x.remove(), x = null
        } else {
...
AmCharts.AmChart = AmCharts.Class({
    ...
    updateWidth: function() { var a = this.divRealWidth,
            ...
            c = this.legend; if (c) { var d = this.legendDiv,
                e = d.offsetWidth;
            isNaN(c.width) || (e = c.width); var f = d.offsetHeight,
                d = d.style,
                g = this.chartDiv.style,
                c = c.position; if ("right" == c || "left" == c) { a -= e; if (0 > a || isNaN(a)) a = 0;
                g.width = a + "px"; "left" == c ? g.left = e + "px" : d.left = a + "px";
                d.top = (b - f) / 2 + "px" } } return a },
    ...
    addMouseWheel: function() { var a = this;
        window.addEventListener && (window.addEventListener("DOMMouseScroll", function(b) { a.handleWheel.call(a, b) }, !1), document.addEventListener("mousewheel", function(b) { a.handleWheel.call(a, b) }, !1)) },
    ...
    addListeners: function() {
        var a = this,
            b = a.chartDiv;
        document.addEventListener ? (a.panEventsEnabled && "ontouchstart" in document.documentElement && (b.addEventListener("touchstart", function(b) { a.handleTouchMove.call(a, b);
            a.handleTouchStart.call(a, b) }, !0), b.addEventListener("touchmove", function(b) { a.handleTouchMove.call(a, b) }, !0), b.addEventListener("touchend",
    ...
    validateNow: function() { this.chartRendered = this.listenersAdded = !1;
        this.write(this.div) },
            ...
            if (a) {
                ...
                switch (this.mouseMode) {
                    case 1:
                        ...
                        if (!this.divIsFixed) { var b = document.body,
                                e, f;
    ...
    animate: function(a, b, c, d, e, f, g) { a["an_" + b] && AmCharts.removeFromArray(this.animations, a["an_" + b]);
    ...
    setLegendData: function(a) { var b = this.legend;
        b && b.setData(a) },
    startInterval: function() { var a = this;
        clearInterval(a.interval);
        a.interval = setInterval(function() { a.updateAnimations.call(a) }, AmCharts.updateRate) },
    stopAnim: function(a) { AmCharts.removeFromArray(this.animations, a) },
    updateAnimations: function() { var a;
        this.container && this.container.update(); for (a = this.animations.length - 1; 0 <= a; a--) { var b = this.animations[a],
                ...
                0 === h ? this.animations.splice(a, 1) : e.node.style[f] = c + b.suffix } else e.node.style[f] = Number(b.to) + b.suffix, this.animations.splice(a, 1) } },
    inIframe: function() {
        try {
            return window.self !==
                window.top
...
AmCharts.AmGraph = AmCharts.Class({
    ...
    createGraph: function() {
        ...
        if (!isNaN(a.valueAxis.min) && !isNaN(a.valueAxis.max)) { switch (b.type) {
                case "serial":
    ...
    createXYGraph: function() {
        ...
        this.pmy = this.pmx = 0;
        var e;
        for (e = this.start; e <= this.end; e++) { var f = this.data[e].axes[c.id].graphs[this.id],
                g = f.values,
                h = g.x,
                k = g.y,
                g = c.getCoordinate(h),
    ...
    createSerialGraph: function() {
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g) {
            if (0 < M) {
                for (J = M - 1; - 1 < J; J--)
                    if (ha = d[J],
                        x = ha.axes[f.id].graphs[b], Wa = x.values.value, !isNaN(Wa)) { M = J; break }
                if (this.lineColorField)
                    for (J = M; - 1 < J; J--)
                        if (ha = d[J], x = ha.axes[f.id].graphs[b], x.lineColor) { this.bulletColorSwitched = this.lineColorSwitched = x.lineColor; break }
                if (this.fillColorsField)
                    for (J = M; - 1 < J; J--)
                        if (ha = d[J], x = ha.axes[f.id].graphs[b], x.fillColors) { this.fillColorsSwitched = x.fillColors; break }
                if (this.dashLengthField)
                    for (J = M; - 1 < J; J--)
                        if (ha = d[J], x = ha.axes[f.id].graphs[b], !isNaN(x.dashLength)) { this.dashLengthSwitched = x.dashLength; break }
            }
            if (ca <
                d.length - 1)
                for (J = ca + 1; J < d.length; J++)
                    if (ha = d[J], x = ha.axes[f.id].graphs[b], Wa = x.values.value, !isNaN(Wa)) { ca = J; break }
        }
        ca < d.length - 1 && ca++;
        var Q = [],
            R = [],
                ...
                switch (g) {
                        ...
                        if (!isNaN(Z)) {
                            if (x.isNegative = Z < ma ? !0 : !1, void 0 ==
                                x.lineColor && void 0 == x.fillColors && isNaN(x.dashLength) || (this.drawLineGraph(u, v, Q, R), u = [], v = [], Q = [], R = [], this.lineColorSwitched = x.lineColor, this.fillColorsSwitched = x.fillColors, this.dashLengthSwitched = x.dashLength), n ? (isNaN(t) || (u.push(t), v.push(C - la)), v.push(C - la), u.push(D), v.push(C + va), u.push(D), !Ea || isNaN(L) || isNaN(N) || (Q.push(y), R.push(L - la), Q.push(N), R.push(L - la), Q.push(N), R.push(L + va))) : (isNaN(w) || (v.push(w), u.push(t), v.push(w), u.push(D - la)), u.push(D - la), v.push(C), u.push(D + va), v.push(C), !Ea ||
                                    isNaN(L) || isNaN(N) || (Q.push(N - la), R.push(E), Q.push(N - la), R.push(L), Q.push(N + va), R.push(L))), t = D, w = C, y = N, E = L, ba = D, fa = C, ja = D, ka = C, zb || x.gap) t = w = NaN, this.drawLineGraph(u, v, Q, R), u = [], v = [], Q = [], R = []
                        } else if (!r) { if (1 >= this.periodSpan || 1 < this.periodSpan && D - t > la + va) t = w = NaN;
                    ...
                    case "column":
                        ...
                        if (!isNaN(Z)) {
                            ...
                            if (!(Z < Bb && na < Bb ||
                                    Z > Cb && na > Cb))
                                if (n) { "3d" == B ? (T = C - 0.5 * (h + F) + F / 2 + G * U, S = N + I * U) : (T = Math.floor(C - (s / 2 - U) * (h + F) + F / 2), S = N);
                                    O = h;
                                    ba = D;
                                    fa = T + h / 2;
                                    ja = D;
                                    ...
                                    aa += Pb - S;
                                    aa = AmCharts.fitToBounds(aa, -S, l - S + I * U); if (T < m && 0 < O && (qa = new AmCharts.Cuboid(e, aa, O, I - a.d3x, G - a.d3y, Ca, Ra, X, oa, $, H, q, n, P, Sa), "bottom" != K && "inside" != K && "middle" != K))
                                        if (K = f.reversed ? "left" : "right", 0 > Z) K = f.reversed ? "right" : "left";
                                        else if ("regular" == B || "100%" == B) ba += this.dx } else {
                                    "3d" == B ? (S =
                    ...
                    case "candlestick":
                        if (!isNaN(na) && !isNaN(Z)) {
                            ...
                            oa = sa;
                            void 0 != x.lineColor && (oa = x.lineColor);
                            if (n) { if (T = C - h / 2, S = N, O = h, T + O > m && (O = m - T), 0 > T && (O += T, T = 0), T < m && 0 < O) { var nb, ob;
                                    ...
                                    aa = D - N;
                                    qa = new AmCharts.Cuboid(e, aa, O, I, G, Ca, Pa, X, oa, $, H, q, n, P, Sa) } } else if (S = D - h / 2, T = L + X / 2, O = h, S + O > l && (O = l - S), 0 > S && (O += S, S = 0), aa =
                                C - L, S < l && 0 < O) { var qa = new AmCharts.Cuboid(e, O, aa, I, G, Ca, Ra, X, oa, $, H, q, n, P, Sa),
                                    pb, qb;
                    ...
                    case "ohlc":
                        if (!(isNaN(na) || isNaN(jb) || isNaN(kb) || isNaN(Z))) {
                            ...
                            if (n) { var ub = C - h / 2,
                                ...
                                tb = AmCharts.line(e, [D, D], [Db, vb], sa, $, X, P) } else {
                                var wb = D -
                                    h / 2,
                ...
                if (!W && !isNaN(Z)) {
                    ...
                    if (this.end - this.start <= Fb || 0 === Fb) {
                        ...
                        if (Gb) {
                            ...
                            if (ea) { if (isNaN(fa) || isNaN(ba)) ea.remove(), ea = null;
                                else if (ba += wa, fa += xa, ea.translate(ba, fa), n) { if (0 > fa || fa > m) ea.remove(), ea = null } else { var Ib = 0; "3d" == B && (Ib = I * U); if (0 > ba || ba > l + Ib) ea.remove(), ea = null }
    ...
    animateColumns: function(a,
        b, c, d, e, f) { var g = this;
        c = g.chart.startDuration;
        0 < c && !g.animationPlayed && (g.seqAn ? (a.set.hide(), g.animationArray.push(a), a = setTimeout(function() { g.animate.call(g) }, c / (g.end - g.start + 1) * (b - g.start) * 1E3), g.timeOuts.push(a)) : g.animate(a)) },
    ...
    drawLineGraph: function(a, b, c, d) {
        ...
        if (1 < a.length) {
            ...
            h.push(l);
            h.click(function(a) { e.handleGraphEvent(a, "clickGraph") }).mouseover(function(a) { e.handleGraphEvent(a, "rollOverGraph") }).mouseout(function(a) { e.handleGraphEvent(a, "rollOutGraph") });
            ...
            if (0 < f || 0 < v)
                if (m =
                    ...
                    k.push(g), k.click(function(a) { e.handleGraphEvent(a, "clickGraph") }).mouseover(function(a) { e.handleGraphEvent(a, "rollOverGraph") }).mouseout(function(a) { e.handleGraphEvent(a, "rollOutGraph") });
            e.applyMask(k, h)
        }
    },
    ...
    createBullet: function(a, b, c, d) {
        ...
        if (this.customBullet || a.customBullet) n = this.customBullet, a.customBullet && (n = a.customBullet), n && (p && p.remove(), "function" == typeof n ? (p = new n, p.chart = this.chart, a.bulletConfig && (p.availableSpace = c, p.graph = this, a.bulletConfig.minCoord = this.minCoord - c, p.bulletConfig = a.bulletConfig), p.write(d),
    ...
    addListeners: function(a, b) {
        ...
        a.mouseover(function(a) { c.handleRollOver(b, a) }).mouseout(function(a) { c.handleRollOut(b, a) }).touchend(function(a) { c.handleRollOver(b, a);
            c.chart.panEventsEnabled && c.handleClick(b, a) }).touchstart(function(a) { c.handleRollOver(b, a) }).click(function(a) { c.handleClick(b, a) }).dblclick(function(a) { c.handleDoubleClick(b, a) }).contextmenu(function(a) {
    ...
    handleRollOver: function(a, b) {
        if (a) {
            var c = this.chart,
                d = { type: "rollOverGraphItem", item: a, index: a.index, graph: this, target: this, chart: this.chart, event: b };
    ...
    handleRollOut: function(a, b) { this.chart.hideBalloon(); if (a) { var c = { type: "rollOutGraphItem", item: a, index: a.index, graph: this, target: this, chart: this.chart, event: b };
...
AmCharts.ChartCursor = AmCharts.Class({
    ...
    getMousePosition: function() { var a, b = this.width,
            c = this.height;
        a = this.chart;
        this.rotate ? (a = a.mouseY - this.y, 0 > a && (a = 0), a > c && (a = c)) : (a = a.mouseX - this.x - 1, 0 > a && (a = 0), a > b && (a = b)); return a },
    ...
    fireMoved: function() { var a = this.chart,
    ...
    arrangeBalloons: function() {
        ...
        var e;
        for (e = 0; e < a.length; e++) { var f = a[e].balloon;
    ...
    normalizeBulletSize: function() { var a = this.resizedBullets; if (a)
        ...
        if (this.enabled) {
            ...
            if (s) {
                ...
                if (c.mouseIsOver || A || I || this.forceShow)
                    if (this.forceShow = !1, I) { var h = this.panClickPos,
                            c = this.panClickEndTime,
                            A = this.panClickStartTime,
                            K = this.panClickEnd,
                            l = this.panClickStart,
                            e = (r ? h - f : h - e) / v; if (!g.parseDates || g.equalSpacing) e = Math.round(e);
                        0 !== e && (h = { type: "zoomed", target: this }, h.chart = this.chart, g.parseDates && !g.equalSpacing ? (c + e > y && (e = y - c), A + e < w && (e = w - A), h.start = Math.round(A + e), h.end = Math.round(c + e), this.fire(h.type, h)) : K + e >= this.data.length || 0 > l + e || (h.start = l + e, h.end = K + e, this.fire(h.type, h))) } else {
                        "start" ==
                        ...
                        if (r) { if (0 > q)
                            ...
                            if (q > n + 1)
                                if (A) q = n + 1;
                                else { this.hideCursor(); return } } else { if (0 > q)
                                if (A) q = 0;
                                else { this.hideCursor(); return }
                            if (q > p)
                                if (A) q = p;
                                ...
                                for (t = 0; t < G.length; t++)
                                    if (g = G[t], (!this.oneBalloonOnly || g == K) && g.showBalloon && !g.hidden && g.balloonText && ("step" == g.type && "left" == g.stepDirection &&
                                        ...
                                        if (!isNaN(y)) {
                                            q = w.x;
                                            u = !0;
                                            if (r) { if (k = y, 0 > q || q > n) u = !1 } else if (k = q, q = y, 0 > k || k > p + h + 1) u = !1;
...
AmCharts.SimpleChartScrollbar = AmCharts.Class({
    construct: function(a) { this.createEvents("zoomed");
    ...
    clipDragger: function(a) { var b = this.getDBox(); if (b) { var c = b.x,
                d = b.y,
                e = b.width,
                b = b.height,
    ...
    hideDragIcons: function() {
        if (!this.resizingLeft && !this.resizingRight &&
            !this.dragging) { if (this.hideResizeGrips || !this.resizeEnabled) this.iconLeft.hide(), this.iconRight.hide();
            this.removeCursors() }
    },
    ...
    draw: function() {
        ...
        if (l = a.graph) {
            ...
            var f = Infinity,
                g = -Infinity,
                s;
            for (s = 0; s < c.length; s++) { var q = c[s].axes[n.id].graphs[l.id].values,
                    r; for (r in q)
                    if (q.hasOwnProperty(r) && "percents" != r && "total" != r) { var u = q[r];
                        u < f && (f = u);
                        u > g && (g = u) } }
...
AmCharts.AmBalloon = AmCharts.Class({
    ...
    hide: function() {
        var a = this,
            ...
            c = a.chart;
        if (0 < b) {
            a.destroyTO = setTimeout(function() { a.destroy.call(a) },
                1E3 * b);
            a.follow = !1;
            a.show = !1;
            var d = a.set;
...
AmCharts.AmCoordinateChart = AmCharts.Class({
    ...
    construct: function(a) {
        ...
        this.colors = "#FF6600 #FCD202 #B0DE09 #0D8ECF #2A0CD0 #CD0D74 #CC0000 #00CC00 #0000CC #DDDDDD #999999 #333333 rgb(3, 57, 145)".split(" ");
    ...
    processGuides: function() {
        ...
        if (a)
            for (var c = 0; c < a.length; c++) { var d = a[c];
                (void 0 !== d.category || void 0 !== d.date) && b && b.addGuide(d); var e = d.valueAxis;
    ...
    formatString: function(a, b, c) { var d = b.graph,
            e = d.valueAxis;
        ...
        a = c ? AmCharts.fixNewLines(a) : AmCharts.fixBrakes(a); return a = AmCharts.cleanFromEmpty(a) },
    getBalloonColor: function(a,
        b, c) { var d = a.lineColor,
            e = a.balloonColor;
        c && (e = d);
        c = a.fillColorsR; "object" == typeof c ? d = c[0] : void 0 !== c && (d = c);
        ...
        void 0 === e && (e = d); return e },
    getGraphById: function(a) { return AmCharts.getObjById(this.graphs, a) },
    getValueAxisById: function(a) { return AmCharts.getObjById(this.valueAxes, a) },
    processFields: function(a, b, c) {
        ...
        for (e = 0; e < d.length; e++) { var f = d[e],
                g = a[f + "Field"];
    ...
    highlightGraph: function(a) { var b = this.graphs,
            c, d = 0.2;
    ...
    hideGraph: function(a) { this.dataChanged = !0;
        this.marginsUpdated = !1;
        a.hidden = !0;
        this.chartCreated && this.initChart() },
...
AmCharts.AmSlicedChart = AmCharts.Class({
    ...
    construct: function(a) {
        ...
        this.colors = "#FF0F00 #FF6600 #FF9E01 #FCD202 #F8FF01 #B0DE09 #04D215 #0D8ECF #0D52D1 #2A0CD0 #8A0CCF #CD0D74 #754DEB #DDDDDD #999999 #333333 #000000 #57032A #CA9726 rgb(3, 57, 145) #4B0C25".split(" ");
        this.alpha = 1;
        this.groupPercent = 0;
    ...
    initChart: function() { AmCharts.AmSlicedChart.base.initChart.call(this);
    ...
    addEventListeners: function(a, b) {
        ...
        a.mouseover(function(a) { c.rollOverSlice(b, !0, a) }).mouseout(function(a) { c.rollOutSlice(b, a) }).touchend(function(a) { c.rollOverSlice(b, a);
            c.panEventsEnabled && c.clickSlice(b, a) }).touchstart(function(a) {
            c.rollOverSlice(b,
                a)
        }).click(function(a) { c.clickSlice(b, a) }).contextmenu(function(a) { c.handleRightClick(b, a) })
    },
    formatString: function(a, b, c) {
        ...
        a = AmCharts.massReplace(a, { "[[title]]": b.title, "[[description]]": b.description }); - 1 != a.indexOf("[[") && (a = AmCharts.formatDataContextValue(a, b.dataContext));
    ...
    rollOutSlice: function(a, b) { isNaN(a) || (a = this.chartData[a]);
        a.wedge && a.wedge.attr({ opacity: 1 });
        this.hideBalloon(); var c = { type: "rollOutSlice", dataItem: a, chart: this, event: b };
        this.fire(c.type, c) },
    clickSlice: function(a, b) { isNaN(a) || (a = this.chartData[a]);
        a.pulled ? this.pullSlice(a, 0) : this.pullSlice(a, 1);
        AmCharts.getURL(a.url, this.urlTarget); var c = { type: "clickSlice", dataItem: a, chart: this, event: b };
        this.fire(c.type, c) },
    handleRightClick: function(a,
        b) { isNaN(a) || (a = this.chartData[a]); var c = { type: "rightClickSlice", dataItem: a, chart: this, event: b };
        this.fire(c.type, c) },
    drawTicks: function() { var a = this.chartData,
            b; for (b = 0; b < a.length; b++) { var c = a[b]; if (c.label) { var d = c.ty,
    ...
    initialStart: function() {
        ...
        a.chartCreated ? a.pullSlices(!0) :
            (b = setTimeout(function() { a.pullSlices.call(a) }, 1200 * b), a.timeOuts.push(b), a.startSlices())
    },
    pullSlice: function(a, b, c) { var d = this.pullOutDuration;!0 === c && (d = 0);
...
AmCharts.AmRectangularChart = AmCharts.Class({
    ...
    resetMargins: function() {
        ...
        if ("serial" == this.type) {
            ...
            for (b = 0; b < c.length; b++) { var d = c[b];
                d.ignoreAxisWidth || (d.setOrientation(this.rotate), d.fixAxisPosition(), a[d.position] = !0) }(b = this.categoryAxis) && !b.ignoreAxisWidth && (b.setOrientation(!this.rotate), b.fixAxisPosition(), b.fixAxisPosition(), a[b.position] = !0)
        } else {
            d = this.xAxes;
            c = this.yAxes;
    ...
    updateValueAxes: function() {
        var a = this.valueAxes,
            ...
            f;
        for (f = 0; f < a.length; f++) { var g = a[f];
    ...
    draw: function() {
        ...
        isNaN(d) || isNaN(e) ||
            isNaN(f) || isNaN(f) || (b.rotate ? (h = [f, g], e = [d, e]) : (h = [d, e], e = [f, g]), f = a.lineColor, d = AmCharts.line(c, h, e, f, a.lineAlpha, a.lineThickness, a.dashLength), g = h, k = e, p = h[1] - h[0], n = e[1] - e[0], 0 === p && (p = 0.01), 0 === n && (n = 0.01), l = p / Math.abs(p), m = n / Math.abs(n), n = p * n / Math.abs(p * n) * Math.sqrt(Math.pow(p, 2) + Math.pow(n, 2)), p = Math.asin(p / n), n = 90 * Math.PI / 180 - p, p = Math.abs(5 * Math.cos(n)), n = Math.abs(5 * Math.sin(n)), g.push(h[1] - l * n, h[0] - l * n), k.push(e[1] + m * p, e[0] + m * p), h = AmCharts.polygon(c, g, k, f, 0.005, 0), c = c.set([h, d]), c.translate(b.marginLeftReal,
                b.marginTopReal), b.trendLinesSet.push(c), a.line = d, a.set = c, h.mouseup(function() { a.handleLineClick() }).mouseover(function() { a.handleLineOver() }).mouseout(function() { a.handleLineOut() }), h.touchend && h.touchend(function() { a.handleLineClick() }))
    },
    handleLineClick: function() { var a = { type: "click", trendLine: this, chart: this.chart };
        this.fire(a.type, a) },
...
AmCharts.circle = function(a, b, c, d, e, f, g, h) { if (void 0 == e || 0 === e) e = 0.01;
    void 0 === f && (f = "#000000");
    void 0 === g && (g = 0);
...
AmCharts.rect = function(a, b, c, d, e, f, g, h, k, l, m) { isNaN(f) && (f = 0);
    void 0 === k && (k = 0);
    void 0 === l && (l = 270);
    isNaN(e) && (e = 0); var p = d,
        n = !1; "object" == typeof p && (p = p[0], n = !0);
    void 0 === g && (g = p);
    void 0 === h && (h = e);
    b = Math.round(b);
    c = Math.round(c); var s = 0,
        q = 0;
    ...
    n && a.gradient("linearGradient", d, l); return a };
...
AmCharts.line = function(a, b, c, d, e, f, g, h, k, l, m) { if (a.handDrawn && !m) return AmCharts.handDrawnLine(a, b, c, d, e, f, g, h, k, l, m);
...
AmCharts.makeHD = function(a, b, c) { for (var d = [], e = [], f = 1; f < a.length; f++)
        for (var g = Number(a[f - 1]), h = Number(b[f - 1]), k = Number(a[f]), l = Number(b[f]), m = Math.sqrt(Math.pow(k - g, 2) + Math.pow(l - h, 2)), m = Math.round(m / 50) + 1, k = (k - g) / m, l = (l - h) / m, p = 0; p <= m; p++) { var n = g + p * k + Math.random() * c,
                s = h + p * l + Math.random() * c;
            d.push(n);
            e.push(s) }
    return [d, e] };
AmCharts.handDrawnLine = function(a, b, c, d, e, f, g, h, k, l, m) { var p = a.set(); for (m = 1; m < b.length; m++)
        for (var n = [b[m - 1], b[m]], s = [c[m - 1], c[m]], s = AmCharts.makeHD(n, s, a.handDrawScatter), n = s[0], s = s[1], q = 1; q < n.length; q++) p.push(AmCharts.line(a, [n[q - 1], n[q]], [s[q - 1], s[q]], d, e, f + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, g, h, k, l, !0)); return p };
...
AmCharts.wedge = function(a, b, c, d, e, f, g, h, k, l, m, p) {
    ...
    var u = 1 / 180 * Math.PI,
        ...
        A = { fill: AmCharts.adjustLuminosity(l.fill, -0.2), "stroke-opacity": 0, "fill-opacity": l["fill-opacity"] },
        I = 0;
    180 < Math.abs(e) && (I = 1);
    d = a.set();
    var G;
...
AmCharts.Bezier = AmCharts.Class({
    ...
    interpolate: function(a) {
        ...
        var g;
        for (g = 1; g < a.length - 1; g++) { var h = a[g - 1],
                k = a[g],
                d = a[g + 1];
            isNaN(d.x) && (d = k);
            isNaN(k.x) && (k = h);
...
AmCharts.AmDObject = AmCharts.Class({
    ...
    translate: function(a, b, c, d) { d || (a = Math.round(a), b = Math.round(b));
    ...
    rotate: function(a, b) { this.R.rotate(this, a, b);
        this.angle = a },
    animate: function(a, b, c) { for (var d in a)
    ...
    clear: function() { var a = this.node; if (a.hasChildNodes())
    ...
    pattern: function(a, b) { a && this.R.pattern(this, a, b) }
});
AmCharts.VMLRenderer = AmCharts.Class({
    ...
    getBox: function(a) {
        var b = a.offsetLeft,
            ...
            e = a.offsetHeight,
            f;
        if (a.hasChildNodes()) { var g, h, k; for (k = 0; k < a.childNodes.length; k++) { f = this.getBox(a.childNodes[k]); var l = f.x;
    ...
    svgPathToVml: function(a) {
        ...
        for (e =
            0; e < b.length; e++) { var f = b[e],
                ...
                p = d(2 / 3 * p + k / 3);
                n = d(2 / 3 * n + s / 3);
                a += " c " + c + "," + m + "," + p + "," + n + "," + k + "," + s } "A" == g && (a += " wa " + f); "B" == g && (a += " at " + f);
            c = h }
        return a
    },
    ...
    gradient: function(a, b, c, d) {
        ...
        var f;
        for (f = 0; f < c.length; f++) { var g = Math.round(100 * f / (c.length - 1)),
                e = e + (g + "% " + c[f]);
            f < c.length - 1 && (e += ",") }
        a = a.fill;
    ...
    pattern: function(a, b) { var c = a.fill;
...
AmCharts.AmLegend = AmCharts.Class({
    ...
    arrangeEntries: function() {
        ...
        var y = w = 0,
            E = f;
        for (t = 0; t < u.length; t++) { var z = u[t];
    ...
    createEntry: function(a) {
        if (!1 !== a.visibleInLegend) {
            ...
            if (this.useGraphSettings)
                if (m = a.type, this.switchType = void 0, "line" == m || "step" == m || "smoothedLine" == m || "ohlc" == m) g = k.set(), a.hidden || (d = a.lineColorR, f = a.bulletBorderColorR), p = AmCharts.line(k, [0, 2 * l], [l / 2, l / 2], d, a.lineAlpha, a.lineThickness, a.dashLength), g.push(p), a.bullet && (a.hidden ||
                    ...
                    m = a.fillColorsR;!0 === a.hidden && (m = d); if (g = this.createMarker("rectangle", m, a.fillAlphas, a.lineThickness, d, a.lineAlpha, s, g)) n = l, g.translate(n, l / 2);
                    m = l }
    ...
    clickMarker: function(a) { this.switchable && (!0 === a.hidden ? this.dispatch("showItem", a) : this.dispatch("hideItem", a));
    ...
    createX: function() { var a = (this.markerSize - 4) / 2,
            ...
            a = AmCharts.line(c, [-a, a], [a, -a]).attr(b); return this.container.set([d, a]) },
...
AmCharts.stringToDate = function(a, b) {
    var c = {},
        d = [{ pattern: "YYYY", period: "year" }, { pattern: "YY", period: "year" }, { pattern: "MM", period: "month" }, { pattern: "M", period: "month" }, { pattern: "DD", period: "date" }, { pattern: "D", period: "date" }, { pattern: "JJ", period: "hours" }, { pattern: "J", period: "hours" }, { pattern: "HH", period: "hours" }, { pattern: "H", period: "hours" }, { pattern: "KK", period: "hours" }, { pattern: "K", period: "hours" }, { pattern: "LL", period: "hours" }, { pattern: "L", period: "hours" }, { pattern: "NN", period: "minutes" }, {
            pattern: "N",
            period: "minutes"
...
AmCharts.getFromDateString = function(a, b, c) { c = c.indexOf(a);
    b = b.substr(c, a.length); "0" == b.charAt(0) && (b = b.substr(1, b.length - 1));
    b = Number(b);
    isNaN(b) && (b = 0); - 1 != a.indexOf("M") && b--; return b };
